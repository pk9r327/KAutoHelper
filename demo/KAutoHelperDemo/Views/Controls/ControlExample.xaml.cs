...
public sealed partial class ControlExample : UserControl
{
    ...
    public string Xaml
    {
        get
        {
            return (string)GetValue(XamlProperty);
        }
        set
        {
    ...
    public string CSharp
    {
        get
        {
            return (string)GetValue(CSharpProperty);
        }
        set
        {
    ...
    public string CSharpSource
    {
        get
        {
            return (string)GetValue(CSharpSourceProperty);
        }
        set
        {
    ...
    public IList<ControlExampleSubstitution> Substitutions
    {
        get
        {
            return (IList<ControlExampleSubstitution>)GetValue(SubstitutionsProperty);
        }
        set
        {
    ...
    public GridLength ExampleHeight
    {
        get
        {
            return (GridLength)GetValue(ExampleHeightProperty);
        }
        set
        {
    ...
    public int WebViewHeight
    {
        get
        {
            return (int)GetValue(WebViewHeightProperty);
        }
        set
        {
    ...
    public int WebViewWidth
    {
        get
        {
            return (int)GetValue(WebViewWidthProperty);
        }
        set
        {
    ...
    public int MinimumUniversalAPIContract
    {
        get
        {
            return (int)GetValue(MinimumUniversalAPIContractProperty);
        }
        set
        {
